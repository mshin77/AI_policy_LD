...
demo_tbl <- delphiFirst %>%
  dplyr::select(position, school_level, spanish_hispanic_latino, race, sex) %>%
  tbl_summary(
              percent = "column") 
...
```{r, echo=FALSE}
save(delphi_long, delphi_long_2, dfm, word_frequency_plot, word_frequency_remove_stopwords, word_frequency_remove_common,
