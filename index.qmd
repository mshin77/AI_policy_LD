...
```{mermaid}
flowchart TD
    n1["Policy Documents Analysis<br/>N=32 documents<br/>3 categories"] --> D["Text Preprocessing<br/>• Tokenization<br/>• Stopword Removal<br/>• Lemmatization"] & B["Delphi Round 1<br/>N=20 experts"]
    B --> C["Delphi Round 2<br/>N=14 experts"] & K1["Expert Validation<br/>After Delphi Round 1"]
    D --> E["Document Categorization<br/>• SLD Policies<br/>• Other Disability Policies<br/>• General AI Policies"]
    E --> F["Document Embeddings<br/>Sentence-BERT<br/>all-MiniLM-L6-v2"] & G["Topic Modeling<br/>Structural Topic Model<br/>K=10 topics per category"]
    F --> H["Similarity Analysis<br/>Cosine Similarity<br/>Threshold: 0.6"]
    G --> I["Topic Label Generation<br/>GPT-3.5-Turbo<br/>Temperature: 0.5"]
    ...
    I --> J["Survey Item Generation<br/>GPT-3.5-Turbo<br/>Temperature: 0"]
