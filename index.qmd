...
```{mermaid}
flowchart TD
    n1["Policy Documents Analysis<br/>N=12 documents<br/>3 categories"] --> D["Document Categorization<br/>• SLD Policies<br/>• Other Disability Policies<br/>• General AI Policies"]
    D --> E["Text Preprocessing<br/>• Tokenization<br/>• Stopword Removal<br/>• Lemmatization"]
    E --> F["Text Embeddings<br/>Sentence-BERT<br/>all-MiniLM-L6-v2"] & G["Topic Modeling<br/>Structural Topic Model<br/>K=10 topics per category"]
    ...
    K2 --> L
    L --> M["Final Policy Items<br/>N=36"]
